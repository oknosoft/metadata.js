...
Копия примера доступна по адресу [oknosoft.ru/assets/examples/unf/](http://www.oknosoft.ru/assets/examples/unf/). Код там не окружен окошками просмотра и живого редактирования, но анализировать и отлаживать его по шагам по {F12} в браузере, пожалуй, даже удобнее, чем в _jsfiddle_
