	...
	split: function(index, parameter) {
		...
		if (index >= 0 && index < curves.length) {
			...
			if (this._closed) {
				...
				path = this._clone(this.isInserted() ? new Path().insertAbove(this, true) : new Path());
			}
			path._add(segs, 0);
	...
	},
{
	...
	getNearestPoint: function() {
		var location = this.getNearestLocation.apply(this, arguments);
		return location ? location.getPoint() : location;
	}
}), new function() {
