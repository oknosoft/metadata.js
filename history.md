...
# v0.9.200
### 06.11.2015
- Дерево _ODynTree_ теперь может содержать не только по папки, но и входящие в эти папки элементы

### 10.11.2015
- Поддержана возможность переключения скиннов (тем оформления)
