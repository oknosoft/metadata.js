...
- Реализована синхронизация с 1С и CouchDB объектов с составным ключом: таких, как _Регистр сведений_ и _Регистр накопления_. Раньше, прозрачная синхронизация поддерживалась только для объектов ссылочного типа
...
### 17.04.2016
- Добавлен класс _SpreadsheetDocument_ (аналог табличного документа в 1С) и методы формирования печатных форм на стороне клиента, в том числе, в автономном режиме. Раньше, отчеты и печатные формы можно было сформировать только на сервере средставми платформы 1С