...
### 13.05.2016
- **!important** Геттеры и Сеттеры полей и табличных частей _DataObj_ сделаны переопределяемыми (в конструкторе _defineProperty_ свойство _configurable_ установлено в _true_). Теперь, движок metadata.js даёт еще больше свободы в определении и переопределении поведения объектов данных со стороны приложения