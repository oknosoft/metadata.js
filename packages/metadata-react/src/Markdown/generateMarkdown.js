...
function generateClasses(reactAPI) {
  const sourceCodeRootUrl = reactAPI.sourceCodeRootUrl || 'https://github.com/oknosoft/flowcon/tree/master';
...
and the [implementation of the component](${sourceCodeRootUrl}${reactAPI.filename})
for more detail.
