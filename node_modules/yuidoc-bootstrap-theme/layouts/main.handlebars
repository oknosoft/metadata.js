...
<head>
    ...
    <link rel="shortcut icon" type="image/ico" href="{{projectAssets}}/favicon.ico">
</head>
...
<div class="navbar navbar-fixed-top">
    <div class="navbar-inner">
        ...
        {{else}}
	    <img alt="{{projectName}}" src="{{projectAssets}}/css/logo.png" style="max-height: 65%;" title="{{projectName}}">
        {{/if}}
            {{projectName}}
        </h1>
	<div class="nav">
            ...
            <li>
                <p class="navbar-text">
                    Документация к версии: <b>{{projectVersion}}</b>
                </p>
            </li>
        </div>
