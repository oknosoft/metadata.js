...
- По окончании срока действия подписки (1 год), Вы в праве использовать ПО версии не выше той, которая была доступна на момент окончания подписки. 
...
- Ни при каких обстоятельствах данное ПО **не может быть использовано для разработки кем-либо другим, кроме лицензированного разработчика(ов)**.
...
- Используя коммерческую лицензию, вы автоматически получаете техническую поддержку [forum support](http://rm.oknosoft.ru/projects/metadata-js) в течение срока действия подписки (один год).
