...
## Зачем использовать Metadata.js?
...
- средства автономной работы с распределённой событийно-целостной синхронизацией данных (CRDT) 
...
- **Скудная функциональность** в работе с данными (на стороне _традиционного клиента 1С_ недоступны объекты данных и метаданных - только _ДанныеФормыСтруктура_ и _ДанныеФормыКоллекция_)
- **Интерфейсные ограничения** тонкого и веб клиентов 1С
